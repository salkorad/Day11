...
function largestNumFromArr(arr) {
    ...
    for (var i=0; i < arr.length; i++) {
        var largestNumber = 0;
        var largNumArray = arr[i];
        for (var j=0; j < largNumArray.length; j++) {
            if (largestNumber < largNumArray[j]) {
                largestNumber = largNumArray[j];
            }
        }
...
console.log(largestNumFromArr([[13, 27, 18, 26], [4, 5, 1, 3], [32, 25, 37, 39], [1000, 1001, 857, 1]])); // Change this line
